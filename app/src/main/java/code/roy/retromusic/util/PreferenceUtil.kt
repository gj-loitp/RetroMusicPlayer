...
import code.roy.retromusic.ALBUM_ARTISTS_ONLY
...
import code.roy.retromusic.ALBUM_DETAIL_SONG_SORT_ORDER
import code.roy.retromusic.ALBUM_GRID_SIZE
import code.roy.retromusic.ALBUM_GRID_SIZE_LAND
import code.roy.retromusic.ALBUM_GRID_STYLE
import code.roy.retromusic.ALBUM_SONG_SORT_ORDER
import code.roy.retromusic.ALBUM_SORT_ORDER
import code.roy.retromusic.APPBAR_MODE
import code.roy.retromusic.ARTIST_ALBUM_SORT_ORDER
import code.roy.retromusic.ARTIST_DETAIL_SONG_SORT_ORDER
import code.roy.retromusic.ARTIST_GRID_SIZE
import code.roy.retromusic.ARTIST_GRID_SIZE_LAND
import code.roy.retromusic.ARTIST_GRID_STYLE
import code.roy.retromusic.ARTIST_SONG_SORT_ORDER
import code.roy.retromusic.ARTIST_SORT_ORDER
import code.roy.retromusic.AUDIO_FADE_DURATION
...
import code.roy.retromusic.CIRCLE_PLAY_BUTTON
import code.roy.retromusic.CLASSIC_NOTIFICATION
import code.roy.retromusic.COLORED_APP_SHORTCUTS
import code.roy.retromusic.COLORED_NOTIFICATION
import code.roy.retromusic.CROSS_FADE_DURATION
import code.roy.retromusic.CUSTOM_FONT
import code.roy.retromusic.DESATURATED_COLOR
import code.roy.retromusic.EXPAND_NOW_PLAYING_PANEL
import code.roy.retromusic.EXTRA_SONG_INFO
import code.roy.retromusic.FILTER_SONG
import code.roy.retromusic.GAP_LESS_PLAYBACK
import code.roy.retromusic.GENERAL_THEME
import code.roy.retromusic.GENRE_SORT_ORDER
import code.roy.retromusic.HOME_ALBUM_GRID_STYLE
import code.roy.retromusic.HOME_ARTIST_GRID_STYLE
import code.roy.retromusic.IGNORE_MEDIA_STORE_ARTWORK
import code.roy.retromusic.INITIALIZED_BLACKLIST
import code.roy.retromusic.KEEP_SCREEN_ON
import code.roy.retromusic.LANGUAGE_NAME
import code.roy.retromusic.LAST_ADDED_CUTOFF
import code.roy.retromusic.LAST_CHANGELOG_VERSION
import code.roy.retromusic.LAST_SLEEP_TIMER_VALUE
import code.roy.retromusic.LAST_USED_TAB
import code.roy.retromusic.LIBRARY_CATEGORIES
import code.roy.retromusic.LOCALE_AUTO_STORE_ENABLED
import code.roy.retromusic.LOCK_SCREEN
import code.roy.retromusic.LYRICS_OPTIONS
import code.roy.retromusic.LYRICS_TYPE
import code.roy.retromusic.MANAGE_AUDIO_FOCUS
import code.roy.retromusic.MATERIAL_YOU
import code.roy.retromusic.NEW_BLUR_AMOUNT
import code.roy.retromusic.NEXT_SLEEP_TIMER_ELAPSED_REALTIME
import code.roy.retromusic.NOW_PLAYING_SCREEN_ID
import code.roy.retromusic.PAUSE_HISTORY
import code.roy.retromusic.PAUSE_ON_ZERO_VOLUME
import code.roy.retromusic.PLAYBACK_PITCH
import code.roy.retromusic.PLAYBACK_SPEED
import code.roy.retromusic.PLAYLIST_GRID_SIZE
import code.roy.retromusic.PLAYLIST_GRID_SIZE_LAND
import code.roy.retromusic.PLAYLIST_SORT_ORDER
import code.roy.retromusic.R
import code.roy.retromusic.RECENTLY_PLAYED_CUTOFF
import code.roy.retromusic.REMEMBER_LAST_TAB
import code.roy.retromusic.SAF_SDCARD_URI
import code.roy.retromusic.SCREEN_ON_LYRICS
import code.roy.retromusic.SHOW_LYRICS
import code.roy.retromusic.SLEEP_TIMER_FINISH_SONG
import code.roy.retromusic.SNOWFALL
import code.roy.retromusic.SONG_GRID_SIZE
import code.roy.retromusic.SONG_GRID_SIZE_LAND
import code.roy.retromusic.SONG_GRID_STYLE
import code.roy.retromusic.SONG_SORT_ORDER
import code.roy.retromusic.START_DIRECTORY
import code.roy.retromusic.SWIPE_ANYWHERE_NOW_PLAYING
import code.roy.retromusic.SWIPE_DOWN_DISMISS
import code.roy.retromusic.TAB_TEXT_MODE
import code.roy.retromusic.TOGGLE_ADD_CONTROLS
import code.roy.retromusic.TOGGLE_FULL_SCREEN
import code.roy.retromusic.TOGGLE_HEADSET
import code.roy.retromusic.TOGGLE_HOME_BANNER
import code.roy.retromusic.TOGGLE_SUGGESTIONS
import code.roy.retromusic.TOGGLE_VOLUME
import code.roy.retromusic.USER_NAME
import code.roy.retromusic.WALLPAPER_ACCENT
import code.roy.retromusic.WHITELIST_MUSIC
import code.roy.retromusic.extensions.getIntRes
import code.roy.retromusic.extensions.getStringOrDefault
...
import code.roy.retromusic.fragments.folder.FoldersFragment
import code.roy.retromusic.helper.SortOrder
import code.roy.retromusic.model.CategoryInfo
import code.roy.retromusic.transform.CascadingPageTransformer
import code.roy.retromusic.transform.DepthTransformation
import code.roy.retromusic.transform.HingeTransformation
import code.roy.retromusic.transform.HorizontalFlipTransformation
import code.roy.retromusic.transform.NormalPageTransformer
import code.roy.retromusic.transform.VerticalFlipTransformation
import code.roy.retromusic.transform.VerticalStackTransformer
import code.roy.retromusic.util.theme.ThemeMode
import code.roy.retromusic.views.TopAppBarLayout
